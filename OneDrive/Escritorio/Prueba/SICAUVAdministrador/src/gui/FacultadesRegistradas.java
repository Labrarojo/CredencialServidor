...
public class FacultadesRegistradas extends javax.swing.JFrame {
    ...
    public FacultadesRegistradas() {
        ...
        registroFacultadTable.setRowHeight(25);//scroll
    }
    ...
    private void initComponents() {
        ...
        registroFacultadTable = new javax.swing.JTable();
        ...
        registroFacultadTable.setAutoCreateRowSorter(true);
        registroFacultadTable.setBackground(new java.awt.Color(255, 255, 250));
        registroFacultadTable.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        registroFacultadTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(registroFacultadTable);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 1150, 470));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/Facultades registradas – 1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacultadesRegistradas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable registroFacultadTable;
