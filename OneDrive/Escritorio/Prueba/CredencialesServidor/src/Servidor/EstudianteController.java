...
public class EstudianteController extends UnicastRemoteObject implements IEstudianteController {
    ...
    public int update(IEstudiante estudiante , String matriculaAnterior) throws RemoteException {
        if (estudiante.getMatricula() == null) {
            return UPDATE_ESTUDIANTE_NULO;
        }

        IEstudiante estudianteEncontrado = findOne(matriculaAnterior);
        ...
        where.put("Matricula", matriculaAnterior);
