...
public class SecretarioController extends UnicastRemoteObject implements ISecretarioController {
    ...
    public int update(ISecretario secretario, String matriculaAnterior) throws RemoteException {
        if (secretario.getMatriculaSecretario() == null) {
            return UPDATE_MATRICULA_NULA;
        }

        ISecretario secretarioEncontrado = findOne(matriculaAnterior);
        ...
        where.put("MatriculaSecretario", matriculaAnterior);
